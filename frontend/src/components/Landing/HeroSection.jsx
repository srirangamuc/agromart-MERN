...
const HeroSection = () => {
  return (
    <div className="relative bg-gradient-to-tl from-green-100 to-gray-200 min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 grid md:grid-cols-2 items-center relative z-10 gap-12 lg:gap-16">
        {/* Text Content */}
        <motion.div 
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-xl mx-auto md:mx-0">
          ...
          <div className="space-y-6">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full md:w-auto flex items-center justify-center space-x-3 bg-green-600 text-white px-6 py-3 rounded-full shadow-lg hover:bg-green-700 transition-colors"
            >
